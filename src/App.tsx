...
import { Container, Grid, Header, Icon, Ref, Sticky } from 'semantic-ui-react'
          ...
          <Grid.Column width={4} style={{ paddingLeft: 0 }}>
            <Container style={{ paddingTop: '1em', paddingRight: '1em' }}>
              <Header as="h3" textAlign="center" block>
                <Icon name="twitter square" /> {process.env.REACT_APP_HASHTAG}
              </Header>
              <TwitterPanel wsUrl={process.env.REACT_APP_WS_URL!} />
            </Container>
          </Grid.Column>
        </Grid>
      </Ref>
